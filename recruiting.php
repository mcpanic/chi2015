...
<div>
  <p>CHI 2015 provides special support for recruiting by offering organizations the opportunity to rent exhibit booth space for this purpose. Informal interview areas are available to recruiters renting exhibit booth space. A complimentary conference registration is also included with each booth rental.</p>
  <ul>
    <li><a href="#recruiting-booth">Recruiting Booth</a></li>
    <li><a href="#recruiting-boards">Recruiting Boards</a></li>
    <li><a href="#sponsoring-opportunities">Sponsoring Opportunities</a></li>
  </ul>

  <h3 id="recruiting-booth">Recruiting Booth</h3>
  <p>For more information on renting a recruiting booth, see the CHI 2015 Invitation to Exhibit (coming in September), or contact Carol Klyver at <a href="mailto:recruiters@chi2015.acm.org">recruiters@chi2015.acm.org</a>.</p>

  <h3 id="recruiting-boards">Recruiting Boards</h3>
